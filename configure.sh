...
# Python detection is now handled by the Bazel repository rule in third_party/python_configure.bzl
...
# Python detection is now handled by the Bazel repository rule.
