...
write_bazelrc "build --per_file_copt=external/com_google_protobuf/.*@-Wno-unused-function,-Wno-stringop-overflow"
write_bazelrc "build --host_per_file_copt=external/com_google_protobuf/.*@-Wno-unused-function,-Wno-stringop-overflow"
