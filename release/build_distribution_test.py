...
# ============================================================================
"""Tests for build_distribution.sh script."""
...
class BuildDistributionTest(unittest.TestCase):
    ...
    def test_dry_run(self):
        """Test build_distribution.sh script in dry-run mode."""
    ...
    def test_defaults(self):
        """Test build_distribution.sh script defaults."""
        cmd = [self.script, "-n"]
        result = subprocess.run(cmd,
                                capture_output=True,
                                text=True,
    ...
    def test_help(self):
        """Test build_distribution.sh script help flag."""
        cmd = [self.script, "-h"]
        result = subprocess.run(cmd,
                                capture_output=True,
                                text=True,
    ...
    def test_invalid_option(self):
        """Test build_distribution.sh script with invalid option."""
        cmd = [self.script, "-z"]
        result = subprocess.run(cmd,
                                capture_output=True,
                                text=True,
