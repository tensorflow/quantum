...
# ============================================================================
"""Tests for clean_distribution.sh script."""
...
class CleanDistributionTest(unittest.TestCase):
    ...
    def test_dry_run(self):
        """Test clean_distribution.sh script in dry-run mode."""
        wheel_path = "fake.whl"
    ...
    def test_show_action(self):
        """Test clean_distribution.sh script with -s (show) action."""
        wheel_path = "fake.whl"
    ...
    def test_missing_arg(self):
        """Test clean_distribution.sh script fails without wheel argument."""
        cmd = [self.script, "-n"]
        result = subprocess.run(cmd,
                                capture_output=True,
                                text=True,
    ...
    def test_help(self):
        """Test clean_distribution.sh script help flag."""
        cmd = [self.script, "-h"]
        result = subprocess.run(cmd,
                                capture_output=True,
                                text=True,
    ...
    def test_invalid_option(self):
        """Test clean_distribution.sh script with invalid option."""
        cmd = [self.script, "-z"]
        result = subprocess.run(cmd,
                                capture_output=True,
                                text=True,
