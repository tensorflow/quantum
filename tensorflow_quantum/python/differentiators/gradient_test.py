...
class GetGradientCircuitsComparisonTest(
        tf.test.TestCase, parameterized.TestCase):
    """Compares gradients via get_gradient_circuits with analytic versions."""
    ...
    def test_comparison(self, differentiator, op, n_qubits, n_programs, n_ops,
                        symbol_names):
        """Compare the analytic gradient to that from get_gradient_circuits."""
