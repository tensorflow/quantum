...
class NoisyExpectationCalculationTest(tf.test.TestCase, parameterized.TestCase):
    ...
    @parameterized.parameters([
        ...
        # },  # ComputeSmall.
        {
            'n_qubits': 5,  # DO NOT SUBMIT
            'batch_size': 7,  # DO NOT SUBMIT
            'noisy': True
        },  # ComputeSmall.
        # {
        #     'n_qubits': 8,
    ...
    def test_simulate_consistency(self, batch_size, n_qubits, noisy):
        ...
        num_samples = [[10000 if noisy else 3] * 4] * batch_size
        ...
        print(f'TONYBOOM op_exps.shape={op_exps.shape}')
        print(f'TONYBOOM cirq_exps.shape={cirq_exps.shape}')
